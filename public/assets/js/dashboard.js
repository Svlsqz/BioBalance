(function ($) {
  ...
  //   if ($("#flotChart").length) {
  //     // Obtenemos los datos desde el atributo data- de la vista
  //     var chartData = document.getElementById('flotChart');
  //     var labels = JSON.parse(chartData.getAttribute('data-labels')); // Fechas
  //     var pesoInicial = JSON.parse(chartData.getAttribute('data-peso-inicial')); // Peso inicial
  //     var pesoFinal = JSON.parse(chartData.getAttribute('data-peso-final')); // Peso seco
  
  //     // Convertir las fechas a formato timestamp (si es necesario para los datos de eje X)
  //     var fechas = labels.map(function(label) {
  //         return new Date(label).getTime(); // convierte las fechas en milisegundos
  //     });
  
  //     // Crear los datos para cada serie (en formato [timestamp, valor])
  ...
  //     var plot = $.plot('#flotChart', [{
  //         data: dashDataFinal, // Datos de peso final (peso seco)
  //         color: '#5e6eed',
  //         lines: {
  //             fillColor: 'rgba(94, 110, 237, 0.03)'
  //         }
  //     }, {
  //         data: dashDataInicial, // Datos de peso inicial
  //         color: '#00cff4',
  //         lines: {
  //             fillColor: 'rgba(230, 246, 249, 0.15)'
  //         }
  ...
  //             color: '#fff',
  //             tickColor: '#eee',
  //             mode: 'time', // Modo tiempo para el eje X
  //             timeformat: "%d/%m/%Y", // Formato de fecha en el eje X
  //             tickSize: [1, "day"], // Un tick por día
  //         }
  //     });
  // }
